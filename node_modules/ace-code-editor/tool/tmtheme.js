...
console.log(plist.parse.lenth);
var parseString = plist.parse;
function parseTheme(themeXml, callback) {
  let res = parseString(themeXml);
  console.log(res);
  callback(res)
}
...
function convertTheme(name, tmThemePath, outputDirectory) {
    console.log("Converting " + name + " from " + tmThemePath);
    ...
    parseTheme(tmTheme, function(theme) {
        ...
        console.log("Saving to " + outputDirectory + "/" + name);
...
if (process.argv.length > 1 && false) {
